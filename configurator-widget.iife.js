 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var rs=Ze;function Gx(t,e){return t===e&&(t!==0||1/t===1/e)||t!==t&&e!==e}var Vx=typeof Object.is=="function"?Object.is:Gx,Wx=rs.useState,Xx=rs.useEffect,jx=rs.useLayoutEffect,$x=rs.useDebugValue;function Yx(t,e){var n=e(),i=Wx({inst:{value:n,getSnapshot:e}}),r=i[0].inst,s=i[1];return jx(function(){r.value=n,r.getSnapshot=e,rf(r)&&s({inst:r})},[t,n,e]),Xx(function(){return rf(r)&&s({inst:r}),t(function(){rf(r)&&s({inst:r})})},[t]),$x(n),n}function rf(t){var e=t.getSnapshot;t=t.value;try{var n=e();return!Vx(t,n)}catch{return!0}}function qx(t,e){return e()}var Kx=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?qx:Yx;Dm.useSyncExternalStore=rs.useSyncExternalStore!==void 0?rs.useSyncExternalStore:Kx,Lm.exports=Dm;var Zx=Lm.exports;/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function S_(){return new Mr({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$f(),fragmentShader:`
		...
		`,blending:Hi,depthTest:!1,depthWrite:!1})}function M_(){return new Mr({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$f(),fragmentShader:`
